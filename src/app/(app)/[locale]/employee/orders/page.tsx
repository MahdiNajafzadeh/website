...
export default async function EmployeeOrdersPage(props: { searchParams: SearchParams; params: Params }) {
    ...
    if (params.user) {
        try {
            ...
            filteredCustomerName = [u.firstName, u.lastName].filter(Boolean).join(" ").trim() || u.email;
        } catch {
