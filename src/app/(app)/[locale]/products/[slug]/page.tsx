...
export default async function ProductDetailPage({ params }: { params: Params }) {
    ...
    const brand = product.brand && typeof product.brand !== "number" ? product.brand : null;
    const localizedName = localizedValue(product.name, locale);
                ...
                <BreadcrumbList>
                    ...
                    {brand ? (
                        <>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbLink
                                    render={<Link href={localeHref(locale, `/brands/${brand.slug ?? brand.id}`)} />}
                                >
                                    {localizedBrandName}
                                </BreadcrumbLink>
                            </BreadcrumbItem>
            ...
            <div className="grid gap-8 md:grid-cols-2">
                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <h1 className="text-2xl font-bold leading-tight md:text-3xl">{localizedName}</h1>
                        {brand ? (
                            <Link
                            ...
                            <CardContent className="p-4">
                                ...
                                <dl className="grid grid-cols-2 gap-y-2 text-sm">
                                    ...
                                    {product.specifications.thickness ? (
                                        <>
                                            <dt className="text-muted-foreground">
                                                {t("product.detail.specs.thickness")}
                                            </dt>
                                    ...
                                    {product.specifications.application ? (
                                        <>
                                            <dt className="text-muted-foreground">
                                                {t("product.detail.specs.application")}
                                            </dt>
