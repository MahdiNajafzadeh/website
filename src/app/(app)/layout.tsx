...
export default async function RootLayout(props: { children: React.ReactNode }) {
	...
	const primaryPhone = getPrimary(
		siteSettings?.phones as unknown as
			| { label?: string | null; number: string; isPrimary?: boolean | null }[]
			| null
			| undefined,
	);
	const primaryEmail = getPrimary(
		siteSettings?.emails as unknown as
			| { label?: string | null; email: string; isPrimary?: boolean | null }[]
			| null
			| undefined,
	);
	const primaryAddress = getPrimary(
		siteSettings?.addresses as unknown as
			| { label?: string | null; address: string; isPrimary?: boolean | null }[]
			| null
			| undefined,
	);
