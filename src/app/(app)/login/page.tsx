    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center bg-white dark:bg-[#111111] px-4 py-12">
            <div className="w-full max-w-[440px]">
                ...
                <p className="mt-2 text-center text-sm font-medium leading-[1.5] text-[#707072] dark:text-[#9e9ea0]">
                ...
                <form onSubmit={onSubmit} noValidate className="mt-8 space-y-5">
                    <div className="space-y-2">
                        <label
                            htmlFor="phone"
                            className="block text-sm font-medium leading-[1.75] text-[#111111] dark:text-white"
                        >
                            {t("auth.phone")}
                        </label>
                        <input
                            ...
                            className="h-12 w-full rounded-[24px] border border-[#cacacb] bg-white dark:bg-[#1a1a1a] dark:border-[#39393b] dark:text-white px-4 text-base font-normal text-[#111111] placeholder:text-[#9e9ea0] outline-none focus:border-[#111111] focus:ring-2 focus:ring-[#111111]/10 dark:focus:border-white"
                        />
