...
export function AccountForm({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="space-y-5 rounded-[18px] border border-[#cacacb] bg-white p-6"
    >
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-1.5">
          <label htmlFor="firstName" className="text-[12px] font-medium uppercase tracking-wide text-[#707072]">
            First name
          </label>
          <input
            id="firstName"
        ...
        <div className="space-y-1.5">
          <label htmlFor="lastName" className="text-[12px] font-medium uppercase tracking-wide text-[#707072]">
            Last name
          </label>
          <input
            id="lastName"
