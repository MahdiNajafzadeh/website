							...
							{priced.map((item) => (
								<li key={item.id} className="flex gap-3 px-4 py-4">
									...
									<div className="flex min-w-0 flex-1 flex-col gap-1">
										<p className="line-clamp-2 text-[14px] font-medium leading-[1.5] text-[#111111]">
											{item.name}
										</p>
										<div className="flex items-center gap-2 flex-wrap">
											{item.hasDiscount ? (
												<>
													...
													<span className="text-[12px] font-medium text-[#707072] line-through">
				...
				{priced.length > 0 && (
					<div className="border-t border-[#e5e5e5] bg-white p-4 space-y-3">
						...
						<div className="flex items-center justify-between">
							...
							<span className="text-[16px] font-medium leading-[1.5] text-[#111111]">
