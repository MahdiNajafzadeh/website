  ...
  return (
    <div className="flex items-end justify-between gap-4 border-b border-[#e5e5e5] pb-4 dark:border-[#39393b]">
      <div className="min-w-0">
        <p className="text-[12px] font-medium uppercase tracking-[0.08em] text-[#707072] dark:text-[#9e9ea0]">{eyebrow}</p>
        <h2 className="mt-1 text-[32px] font-medium leading-[1.2] tracking-[-0.01em] text-[#111111] dark:text-white" id={titleId}>
          {title}
        </h2>
      </div>
