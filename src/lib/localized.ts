...
export const localizedValue = <T>(value: T | LocalizedShape | null | undefined, locale: Locale): string => {
    ...
    const firstString = Object.values(obj).find((v): v is string => typeof v === "string" && v.length > 0);
    return firstString ?? "";
};
