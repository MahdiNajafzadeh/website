...
import { TranslationProvider, useTranslation } from "@/components/i18n/TranslationProvider";
...
describe("useTranslation", () => {
    const wrap = (locale: "en" | "fa") => {
        return ({ children }: { children: ReactNode }) => createElement(TranslationProvider, { locale, children });
    };
